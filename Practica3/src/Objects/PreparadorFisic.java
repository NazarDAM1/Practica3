...
public class PreparadorFisic extends MembrePlantilla {
    ...
    public PreparadorFisic(String nie, String nom, String cognom, LocalDate dataNaix, int telefon, String email,
            int souBase, String nSS,LocalDate diaFitxa) {
        super(nie, nom, cognom, dataNaix, telefon, email,  souBase, nSS);
