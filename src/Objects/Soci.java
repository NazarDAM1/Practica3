...
public class Soci extends Persona {
    ...
    public Soci(String dni, String nom, String cognom, LocalDate dataNaix, int telefon, String email,
            int quotaAnual) {
    ...
    public static void setQuotaAnual(int quotaAnual) {
        quotaAnual = quotaAnual;
    }
