...
public class ClubFutbol {
    ...
    private void altaMigCampista() {
        ...
        membresPlantilla.put(nie, new Migcampista(nie, nom, cognom, LocalDate.parse(data), telefon, correu, salari, NSS,
    ...
    private void altaPreparadorsFisics() {
        ...
        membresPlantilla.put(nie, new PreparadorFisic(nie, nom, cognom, LocalDate.parse(data), telefon, correu, salari,
    ...
    private void altaEntrenadors() {
        ...
        membresPlantilla.put(nie,
                new Entrenador(nie, nom, cognom, LocalDate.parse(data), telefon, correu, salari, NSS, numtrofeus));
