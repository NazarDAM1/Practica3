...
public class ClubFutbol {
    ...
    public void gestioClubFutbol() {
        ...
        String dni1 = "x462";
        String dni2 = "x4612";
        socis.put(dnii, new Soci("x461", "Nazar ", "Yakovyna",
                LocalDate.parse("2020-01-08"), 642753900, "soci1@gmail.com", 1000));
        socis.put(dni1, new Soci("x461", "Clara ", "Portillo",
                LocalDate.parse("2020-01-08"), 642753900, "soci1@gmail.com", 3000));
        socis.put(dni2, new Soci("x461", "Fermin ", "Costa",
                LocalDate.parse("2020-01-08"), 642753900, "soci1@gmail.com", 1000));

        membresPlantilla.put("x12312", new Davanter("dni", "Nazar", "yakovyna", LocalDate.parse("2020-01-08"), 641,
                "email@gmail.com", 1900, "x3123123", true, 33, 3));

        System.out.println(membresPlantilla.get("x12312").toString());

        membresPlantilla.put("x123", new Defensa("dni", "Nazar", "yakovyna", LocalDate.parse("2020-01-08"), 641,
                "email@gmail.com", 1900, "x3123123", true, 33, 3));
        membresPlantilla.put("x123123", new Davanter("dni", "Nazar", "yakovyna", LocalDate.parse("2020-01-08"), 641,
                "email@gmail.com", 1900, "x3123123", true, 33, 3));
                crearPersona();
    ...
    public void crearPersona() {
        Persona.setNom("asdasd");
        Persona.setCognom("asdasd");
        Persona.setDni("asdasd"); 
        Persona.setDataNaix(LocalDate.parse("2002-02-02"));
        Persona.setTelefon(123123);
        Persona.setEmail("nazar@gmail.com");
        Soci.setQuotaAnual(333);


        socis.put("x32133", new Soci());


        socis.get("x32133").toString();
